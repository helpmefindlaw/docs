...
**Q: Can I use the Flow Input Block in the main flow?**

A: Yes, you can use the Flow Input Block in the main flow to define inputs for the flow. These inputs can be provided when calling the flow using the SDK. See the [RunFlowOptions](../api-reference/block/RunFlowOptions) documentation for more info.
