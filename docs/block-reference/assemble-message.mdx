...
The Assemble Message Block can be used in conjunction with the [Image Block](./image.mdx) or [URL Reference Block](./url-reference.mdx) to include images in a message.
